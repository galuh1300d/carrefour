...
class Lokasi extends Component {
  ...
  onClick = () => this.setState({zoomMap: true})
  ...
  render() {
    ...
    return (
      ...
      <div className="ml-2">
        <button onClick={this.onClick} className="btn btn-outline-danger">Cari</button>
      </div>
      </div>
      <div className="mt-5">
      {this.state.zoomMap ?
        ...
        /> : 
        <img height="400px" src="/assets/peta.png" alt="peta"/>
      }
      </div>
    </div>
    )
